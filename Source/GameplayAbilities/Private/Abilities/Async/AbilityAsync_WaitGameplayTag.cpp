...
void UAbilityAsync_WaitGameplayTag::GameplayTagCallback(const FGameplayTag InTag, int32 NewCount, const FGameplayTag TriggerTag, EOnGameplayEffectTagCountOperation TagOperation)
{
