...
void UTargetTagRequirementsGameplayEffectComponent::OnTagChanged(const FGameplayTag GameplayTag, int32 NewCount, const FGameplayTag TriggerTag, EOnGameplayEffectTagCountOperation Operation, FActiveGameplayEffectHandle ActiveGEHandle) const
{
